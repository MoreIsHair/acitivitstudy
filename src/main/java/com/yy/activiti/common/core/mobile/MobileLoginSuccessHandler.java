...
public class MobileLoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        try {
            ...
            ClientDetails clientDetails = clientDetailsService.loadClientByClientId("test");
            TokenRequest tokenRequest = new TokenRequest(new HashMap<>(16), clientDetails.getClientId(), clientDetails.getScope(), "mobile");
            //校验scope
